...
const modulos = [
    ...
    },
    {
        ...
        links: [
            ...
            { to: '/ciclofacturacion',       icon: 'bi-receipt',           label: 'Ciclo Facturacion' },
            { to: '/tiposervicio',       icon: 'bi-receipt',           label: 'Tipo Servicio' },
            ...
            { to: '/acuerdos-pago',          icon: 'bi-handshake',         label: 'Acuerdos de Pago' },
    ...
    },
    {
        ...
        links: [
            ...
            { to: '/persona',              icon: 'bi-car-front-fill',label: 'Persona' },
            { to: '/arrendatario',              icon: 'bi-car-front-fill',label: 'Arrendatario' },
        ],
    },
    {
        id: 'acceso',
...

    {
        ...
        color: '#6c757d',
        links: [
            { to: '/bancos',        icon: 'bi-house-gear',        label: 'Bancos' },
            { to: '/metodos-pago',        icon: 'bi-house-gear',        label: 'Métodos de Pago' },
            { to: '/tipo-propiedad',        icon: 'bi-house-gear',        label: 'Tipo de Propiedad' },
            { to: '/pais',        icon: 'bi-house-gear',        label: 'Pais' },
            { to: '/parentesco',        icon: 'bi-house-gear',        label: 'Parentesco' },
            { to: '/propiedades',        icon: 'bi-house-gear',        label: 'Propiedades' },
            { to: '/tipocontrato',         icon: 'bi-list-check',        label: 'Tipo Contrato' },
            { to: '/tipomodena',                icon: 'bi-bank2',             label: 'Tipo de Moneda' },
            { to: '/motivovisita',          icon: 'bi-wallet2',           label: 'Motivo Visita' },
            { to: '/concepto-descuento',          icon: 'bi-wallet2',           label: 'Concepto de Descuento' },
        ],
    },
];
