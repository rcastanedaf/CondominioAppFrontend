...
// Componentes de vistas directas
...
import TipoMoneda          from './modules/catalogos/TipoMonedaTable';
...
import ContratoFiltrado    from './modules/contratos/ContratoFiltradoTable';
...
import ConceptoDescuento   from './modules/catalogos/ConceptoDescTable';
        ...
        <BrowserRouter>
            <Routes>
                ...
                >
                    ...
                    <Route path="/tipomodena"         element={<TipoMoneda />} />
                    <Route path="/motivovisita"       element={<MotivoVisita />} />
                    <Route path="/concepto-descuento" element={<ConceptoDescuento />} />
                    ...
                    <Route path="/contratosvigentes"
                        element={<ContratoFiltrado tipo="VIGENTE" />} />
                    <Route path="/contratosvencidos"
                        element={<ContratoFiltrado tipo="VENCIDO" />} />
                ...
                {/* Cualquier ruta desconocida → login si no autenticado, home si autenticado */}
