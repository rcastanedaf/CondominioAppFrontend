...
const CRUD_CARDS = [
  ...
  { id: 'arrendatarios', label: 'Arrendatarios', emoji: '🔑', desc: 'Gestión de arrendatarios',        color: '#fd7e14' },
  { id: 'familiares',  label: 'Familiares', emoji: '👨‍👩‍👦', desc: 'Dependientes y familiares',         color: '#6f42c1' },
