...
import RolPermisosTable from './RolPermisosTable'

const CRUD_CARDS = [
  { id: 'usuarios',  label: 'Usuarios del Sistema', emoji: '👤', desc: 'Gestión de cuentas de acceso',       color: '#6610f2' },
  { id: 'roles',     label: 'Roles y Permisos',      emoji: '🛡️', desc: 'Control de acceso por roles',       color: '#0d6efd' },
  { id: 'auditoria', label: 'Log de Auditoría',      emoji: '🔍', desc: 'Bitácora de acciones del sistema',  color: '#198754' },
]

const SUB_VIEWS = {
  usuarios:  (color) => <UsuarioTable      moduleColor={color} />,
  roles:     (color) => <RolPermisosTable  moduleColor={color} />,
