...
import CuentaCobrarTable  from './CuentaCobrarTable'
import CobroMoraTable     from './CobroMoraTable'
import MultaTable         from './MultaTable'

const CRUD_CARDS = [
  { id: 'pagos',           label: 'Pagos',            emoji: '💳', desc: 'Pagos registrados',         color: '#0dcaf0' },
  { id: 'cuentas-cobrar',  label: 'Cuentas x Cobrar', emoji: '📋', desc: 'Saldos pendientes',         color: '#fd7e14' },
...
const SUB_VIEWS = {
  'pagos':          (color) => <PagoTable moduleColor={color} />,
  'cuentas-cobrar': (color) => <CuentaCobrarTable moduleColor={color} />,
